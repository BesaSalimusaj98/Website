  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.formSection}>
        <h2 className={styles.sectionTitle}>{t('contact.form.sectionTitle')}</h2>
        <p className={styles.sectionSub}>{t('contact.form.sectionSub')}</p>

        <div className={styles.formCard}>
          <h3 className={styles.cardTitle}>{t('contact.form.cardTitle')}</h3>
          <p className={styles.cardSub}>{t('contact.form.cardSub')}</p>
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
              <div className={styles.row}>
                <div className={styles.inputWrap}>
                  ...
                  <input required placeholder={t('contact.form.name')} value={form.name}
                ...
                <div className={styles.inputWrap}>
                  ...
                  <input required type="email" placeholder={t('contact.form.email')} value={form.email}
              ...
              <div className={styles.row}>
                <div className={styles.inputWrap}>
                  ...
                  <input placeholder={t('contact.form.organization')} value={form.org}
                ...
                <div className={styles.inputWrap}>
                  ...
                  <input placeholder={t('contact.form.phone')} value={form.phone}
              ...
              <div className={styles.inputWrap}>
                ...
                <textarea required rows={4} placeholder={t('contact.form.message')} value={form.message}
                  onChange={(e) => setForm({ ...form, message: e.target.value })} />
              </div>
              <div className={styles.formFooter}>
                <span className={styles.privacy}>{t('contact.form.privacy')}</span>
      ...
      <section className={styles.getInTouch}>
        <h2 className={styles.sectionTitle}>{t('contact.getInTouch.title')}</h2>
        <div className={styles.contactGrid}>
          <div className={styles.contactCard}>
            ...
            <div>
              <strong className={styles.contactLabel}>{t('contact.getInTouch.emailLabel')}</strong>
              <p className={styles.contactVal}>info@stazhlink.com.</p>
              <p className={styles.contactNote}>{t('contact.getInTouch.emailNote')}</p>
            </div>
          </div>
          <div className={styles.contactCard}>
            ...
            <div>
              <strong className={styles.contactLabel}>{t('contact.getInTouch.addressLabel')}</strong>
              <p className={styles.contactVal}>{t('contact.getInTouch.addressVal')}</p>
            </div>
          </div>
        </div>
      </section>
